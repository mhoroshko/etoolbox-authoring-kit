...
public class AnnotationUtil {
     ...
     */
    public static class ExtensionInvocationHandler<T, U, R> implements InvocationHandler {
         ...
         */
        public ExtensionInvocationHandler(T source, Class<U> targetType, Map<String, BiFunction<T, Object[], R>> extensionMethods) {
            this.source = source;
